Vue.component("edit-shopping-cart", {
	data: function () {
		return {
			restaurant: {},
			shoppingCartItem: {},
	...
	template: `
		...
		<div>
		<h3>Edit order</h3>
		<img height="100" width="100"  v-bind:src="getLogoPath(shoppingCartItem.item)">
			<table>
					<tr>
						<td> Item name: </td>
					...
					<tr>
						<td> Price: </td>
						<td> {{shoppingCartItem.item.price}} </td>
					</tr>
					<tr>
						<td> Type: </td>
						<td> {{shoppingCartItem.item.type}} </td>
					</tr>
					<tr>
						<td> Quantity: </td>
						<td> {{shoppingCartItem.item.quantity}} </td>
					</tr>
					<tr>
						<td> Description: </td>
	...
	mounted() {
		this.shoppingCartItem = this.$route.params.data;
		this.restaurant = this.$route.params.data1;
