Vue.component("view-restaurant-admin", {
	data: function() {
		return {
			restaurant: {},
			items: [],
					...
					<div class="col-lg-8 col-md-10 col-sm-12 container-neutral">
						<div class="d-flex mb-2">
							...
							<div>
								...
								<small class="mb-1 mt-0 ms-1"><i> Manager: {{restaurant.managerUsername}} </i></small>
							</div>
						</div>						
						<div class="d-flex">
						...
						<ul class="list-group">
							<li class="list-group-item" v-for="comment in comments">
								...
								<div class="d-grid gap-2 d-md-flex justify-content-md-end align-items-center">
									<small class = "float-end" v-if="comment.status == 'PENDING'"> Pending </small>
									...
									<button @click="deleteComment(comment)" class="btn btn-outline-secondary btn-sm me-md-2" type="button"><i class="bi bi-trash"></i></button>
								</div>
							</li>
						</ul>
					</div>
